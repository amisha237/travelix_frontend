...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"login","method":"post","propertyName":"meta.token"},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"user","method":"get","propertyName":"data"}},"_name":"local"}))
